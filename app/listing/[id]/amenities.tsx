...
export default function AmenitiesModal() {
    ...
    const groups = useMemo<AmenityGroup[]>(() => {
        ...
        return [
            {
                key: "all",
                title: { ar: "كل المرافق و المميزات", en: "All Amenities" },
    ...
    return (
        <PlainModalShell
            title={t({ ar: "كل المرافق و المميزات", en: "All Amenities" })}
        >
            <ScrollView
            ...
            >
                {groups.length === 0 ? (
                    ...
                    >
                        {t({ ar: "لا توجد مرافق بعد", en: "No amenities yet" })}
                    </ThemedText>
                ) : null}
