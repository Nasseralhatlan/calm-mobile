      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleCenter} pointerEvents="none">
          <ThemedText
            ...
            numberOfLines={1}>
            {t({ ar: 'تغيير الدولة', en: 'Change country' })}
          </ThemedText>
        </View>
      </View>
      ...
      {countries.length === 0 ? (
        <View style={styles.empty}>
          <ThemedText
            ...
            {t({ ar: 'تعذر تحميل الدول', en: 'Could not load countries' })}
          </ThemedText>
        </View>
      ) : (
        <FlatList
          data={
            filtered.length % 2 === 1
              ? ([
                  ...filtered,
                  { id: '__spacer__', __spacer: true } as ApiCountry & {
                    __spacer?: boolean;
                  },
                ] as ApiCountry[])
              : filtered
          ...
          renderItem={({ item }) => {
            ...
            const isSelected = country?.id === item.id;
            return (
              <PressableScale
                scaleTo={0.97}
                haptic="none"
